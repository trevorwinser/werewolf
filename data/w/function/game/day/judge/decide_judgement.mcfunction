...
execute as @a[team=mayor] run scoreboard players operation .total judgement += @s judgement
execute as @a[tag=!spectator,scores={judgement=1}] run tellraw @a [{selector:"@s"},{text:" voted ",color:white},{text:"Innocent",color:green}]
execute as @a[tag=!spectator,scores={judgement=0}] run tellraw @a [{selector:"@s"},{text:" Abstained",color:gray}]
execute as @a[tag=!spectator,scores={judgement=-1}] run tellraw @a [{selector:"@s"},{text:" voted ",color:white},{text:"Guilty",color:red}]
