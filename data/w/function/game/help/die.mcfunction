...
function w:game/help/remove_active with storage w:temp temp_role
function w:game/help/reveal_role with storage w:temp temp_role
...
tag @s add spectator
tellraw @s "Use /trigger roles to view player roles"
scoreboard players enable @s roles