...
execute as @a[tag=!spectator,tag=deflector] run function w:role/handle {path:"action"}

# Note:
# When the fall guy takes the place of one of their cult members, they will essentially be twice as visitable.
execute as @a[tag=!spectator,tag=fallguy] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=werewolf] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=arsonist] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=cultleader] run function w:role/handle {path:"action"}

# Generic Killing
execute as @a[tag=!spectator,tag=acolyte] run function w:role/handle {path:"action"}
execute as @a[tag=!spectator,tag=sheriff] run function w:role/handle {path:"action"}
execute as @a[tag=!spectator,tag=serialkiller] run function w:role/handle {path:"action"}
...
execute as @a[tag=!spectator,tag=medic] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=scout] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=deputy] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=detective] run function w:role/handle {path:"action"}

execute as @a[tag=!spectator,tag=mayor] run function w:role/handle {path:"action"}