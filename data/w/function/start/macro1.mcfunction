...
$data modify storage w:temp inner_for_loop.name set from storage w:temp role_choice[$(start)].name
data modify storage w:temp inner_for_loop.command set value "function w:start/macro2 with storage w:temp inner_for_loop"
