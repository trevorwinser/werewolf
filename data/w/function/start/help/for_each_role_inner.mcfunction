...
$data modify storage w:temp inner_for_loop.value set value "$(inner_for_loop_value)"
...
execute unless data storage w:temp inner_for_loop{value:"available"} store result score temp storage run data get storage w:temp role.$(value)
