...
execute if score @s role_uses matches 1.. run item replace entity @s container.3 with red_dye[consumable={consume_seconds:10000},custom_name={text:"Right Click to Deflect",italic:false,color:red}]
