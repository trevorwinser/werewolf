...
execute if data storage w:temp clue{type:"town",subtype:"support"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:green,text:" is helpful"}]
execute if data storage w:temp clue{type:"town",subtype:"power"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:green,text:" supports a just cause"}]
execute if data storage w:temp clue{type:"cult",subtype:"power"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:green,text:" supports an unjust cause"}]
execute if data storage w:temp clue{type:"cult",subtype:"support"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:red,text:" supports an unjust cause"}]
execute if data storage w:temp clue{subtype:"killing"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:gold,text:" can kill"}]
execute if data storage w:temp clue{subtype:"investigative"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:green,text:" supports a just cause"}]
execute if data storage w:temp clue{subtype:"evil"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,selector:"@a[tag=investigate]"},{italic:true,color:red,text:" is evil"}]
execute if data storage w:temp clue{subtype:"none"} run tellraw @s [{text:"[Investigation]: ",color:green},{color:white,text:"There is nothing interesting about "},{italic:true,color:white,selector:"@a[tag=investigate]"}]
