...
execute if score @s target1 matches 0 if entity @a[tag=random] run tellraw @s [{text:"You forgot to choose a target! You randomly picked "},{selector:"@a[tag=random]"}]
