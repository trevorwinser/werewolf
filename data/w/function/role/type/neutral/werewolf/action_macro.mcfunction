...
execute if score @s role_action matches 2 run tellraw @a[tag=mauled] [{color:blue,text:"[Mauled] "},{color:white,text:"You were mauled visiting the werewolf last night"}]