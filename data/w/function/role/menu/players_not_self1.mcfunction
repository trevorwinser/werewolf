...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute if data storage w:temp state{time:"Day"} run item replace entity @s container.7 with gray_dye[consumable={consume_seconds:10000},custom_name={text:"Right Click to Rescind Vote",italic:false,color:gray}]
