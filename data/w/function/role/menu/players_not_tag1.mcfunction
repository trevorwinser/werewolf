...
execute at @s as @a[tag=player_1,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
...
execute at @s as @a[tag=player_2,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute at @s as @a[tag=player_3,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute at @s as @a[tag=player_4,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute at @s as @a[tag=player_5,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute at @s as @a[tag=player_6,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute at @s as @a[tag=player_7,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
execute at @s as @e[type=item,distance=..3,tag=!renamed] run data modify storage w:temp text2 set from entity @s Item.components."minecraft:profile".name
execute at @s as @e[type=item,distance=..3,tag=!renamed] run function w:role/menu/set_name with storage w:temp
...
execute at @s run tag @e[type=item,distance=..3] add renamed
execute unless data storage w:temp state{time:"Night"} at @s as @a[tag=player_8,tag=!spectator,tag=!me] run loot spawn ~ ~ ~ loot w:head
