...
function w:config/display/add_or_remove {Pos:"29 2 0",rotation:90,text:"Any (Individual)",path:"role.anyindividual",max:"score role.amount storage matches ..10 if score role.individualamount storage matches ..1",min:"score role.anyindividual storage matches 1.."}
...
function w:config/display/toggle {Pos:"29 1.2 0",rotation:90,text:"Sabotager",path:"role.sabotager",id:"tripwire_hook",big:0.7,small:0.5,on:"score role.amount storage matches ..10 if score role.individualamount storage matches ..1",off:"entity @s",info:""}
function w:config/display/toggle {Pos:"29 1 1",rotation:90,text:"Werewolf",path:"role.werewolf",id:"ghast_tear",big:0.7,small:0.5,on:"score role.amount storage matches ..10 if score role.individualamount storage matches ..1",off:"entity @s",info:""}
