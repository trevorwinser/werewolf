...
function w:config/display/button {Pos:"29 0 0",rotation:90,text:"Presets\n",color:"white",scale:1.5,command:"function w:config/section/roles/presets/load",sound:"minecraft:block.wooden_button.click_on"}