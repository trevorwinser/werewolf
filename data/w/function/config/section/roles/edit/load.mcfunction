...
function w:config/display/button {Pos:"29 1 4.0",rotation:90,text:"Evil\n",color:"white",scale:1.5,command:"function w:config/section/roles/evil/load",sound:"minecraft:block.wooden_button.click_on"}