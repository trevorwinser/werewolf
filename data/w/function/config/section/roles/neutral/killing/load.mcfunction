...
function w:config/display/toggle {Pos:"29 1 0",rotation:90,text:"Werewolf",path:"role.werewolf",id:"ghast_tear",big:0.7,small:0.5,on:"score role.amount storage matches ..10 if score role.individualamount storage matches ..1",off:"entity @s",info:""}
