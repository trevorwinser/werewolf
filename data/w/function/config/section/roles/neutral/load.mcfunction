...
function w:config/display/button {Pos:"29 1 -3",rotation:90,text:"Evil\n",color:"white",scale:1.5,command:"function w:config/section/roles/neutral/evil/load",sound:"minecraft:block.wooden_button.click_on"}
function w:config/display/button {Pos:"29 1 0",rotation:90,text:"Chaos\n",color:"white",scale:1.5,command:"function w:config/section/roles/neutral/chaos/load",sound:"minecraft:block.wooden_button.click_on"}
function w:config/display/button {Pos:"29 1 3",rotation:90,text:"Killing\n",color:"white",scale:1.5,command:"function w:config/section/roles/neutral/killing/load",sound:"minecraft:block.wooden_button.click_on"}