...
function w:config/display/add_or_remove {Pos:"29 2 0",rotation:90,text:"Any (Neutral)",path:"role.anyneutral",max:"score role.amount storage matches ..10",min:"score role.anyneutral storage matches 1.."}
...
function w:config/display/toggle {Pos:"29 1.2 0",rotation:90,text:"Jester",path:"role.jester",id:"firework_rocket",big:0.7,small:0.5,on:"score role.amount storage matches ..10",off:"entity @s",info:""}
#function w:config/display/toggle {Pos:"29 1 1",rotation:90,text:"Scout",path:"role.scout",id:"sugar",big:0.7,small:0.5,on:"score role.amount storage matches ..10",off:"entity @s",info:""}
