...
execute if entity @e[nbt={text:{text:"Roles"}}] run function w:help/for_loop/start with storage w:temp for_loop

execute if entity @e[nbt={text:{text:"Roles"}}] positioned 29.95 0 4.0 run tag @n[type=text_display,distance=..0.1] add role_list
